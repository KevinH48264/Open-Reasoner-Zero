...
class PPOExpConfig(BasePPOExpConfig):
    ...
    # configs
    version = "v1673" # TODO: update this!
...
Math Teacher Response: <think>'''
    ...
    async def generate_vllm(
        ...
        **kwargs,
        ...
        # # print one case where the semantic grader disagrees with the is_equal() function
        # for i, (eq, sem, extra, final, sem_prompt, sem_res) in enumerate(zip(equal_results, semantic_ok, extras, final_answers, semantic_prompts, semantic_responses)):
        #     if eq != sem:
        #         logger.info(
        #             f"\n\n[STEP {self.global_step}] Disagreement at index {i}: "
        #             f"\n\nequal_results={eq}, "
        #             f"\n\nsemantic_ok={sem}, "
        #             f"\n\nsemantic_prompt={sem_prompt}, "
        #             f"\n\nsemantic_response={sem_res}, "
        #         )
        #         break
